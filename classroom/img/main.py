...
class Application(Frame):
    ...
    def __init__(self, master=None):
        ...
        Label(master, text='H U F F M A N - C O D I N G', font="courier 14 bold").grid(row=0, columnspan=3, pady=(0,20))
        ...
        # label du panel
        self.label_for_text  = Label(master, text ="ENTER YOUR STRING" )
        ...
        Button(master, text='CLICK', command=self.compute_and_display).grid(row=3)
        ...
        # label du panel
        self.label_for_tree  = Label(master, text ="DETAILS" )
        ...
        self.label_for_binary_text      = Label( master, width = 50, text = 'HUFFMAN CODE')
    ...
    def compute_and_display(self):
        ...
        if text:
            ...
            self.label_for_text.config(text='ENTER YOUR STRING'.format(len(text)))  
            ...
            self.label_for_binary_text.config(text='HUFFMAN CODE: {} bits'.format(len(self.text_binary.get(1.0, 'end-1c'))))
